	...
	function frame(){
		...
		if (biggerMe == tamanoCirculo*100) {
			...
			circleFruit.onclick = function() {
				...
				//informacion.style.transform = "scale(" + 1 + ", " + 1 + ")";

				var	cuantosMeses = meses.length;

//				informacion.innerHTML = "<p>"+ nameFruit + "</p>" + "</br>" + "</br>" + "</br>" + "<h6>"+ meses[0] + " " + "-" + " " +  cuantosMeses + "</h6>";
				informacion.style.backgroundColor = colorFruit;
				var interior = document.getElementById("recTrans");
				/////----->///// interior.innerHTML = "<p>"+ nameFruit + "</p>" + "</br>" + "</br>" + "</br>" + "<h6>"+ meses[0] + " " + "-" + " " +  cuantosMeses + "</h6>";
				...
				//infoQueMeses.innerHTML = meses[0] + " - " + meses[meses.length-1];
				...
				//document.getElementById("fruitInfo").appendChild(interior);
